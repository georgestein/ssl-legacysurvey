"""Copied from https://github.com/PyTorchLightning/lightning-bolts/tree/master/pl_bolts in order to (possibly) adapt some small changes

Originally adapted from: https://github.com/facebookresearch/moco.
